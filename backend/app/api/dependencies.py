...
from app.clients.openrouter_service import get_openrouter_service as _get_openrouter_service
...
async def verify_project_ownership(
    ...
    try:
        ...
        logger.error(f"Error verifying project ownership for {project_id}: {e}", exc_info=True)
