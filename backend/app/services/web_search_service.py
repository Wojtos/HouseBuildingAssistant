...
class WebSearchService:
    ...
    SEARCH_TRIGGERS = {
        "pricing": [
            # English
            "current price", "cost today", "rates in", "average cost",
            "how much does", "price of", "pricing for", "land price",
            "plot price", "property price", "real estate price",
            # Polish
            "cena", "ceny", "koszt", "kosztuje", "ile kosztuje", "średnia cena",
            "cena działki", "cena gruntu", "cena ziemi", "wycena",
        ],
        "regulations": [
            # English
            "building code", "permit requirement", "zoning", "regulation in",
            "legal requirement", "code requirement", "ordinance",
            # Polish
            "przepisy", "regulacje", "pozwolenie", "prawo budowlane",
            "warunki zabudowy", "mpzp", "plan miejscowy",
        ],
        "contractors": [
            # English
            "contractor near", "builder in", "find a", "recommend a",
            "supplier in", "company in", "service provider",
            # Polish
            "wykonawca", "firma budowlana", "ekipa", "fachowiec",
            "polecić", "znaleźć wykonawcę",
        ],
        "market": [
            # English
            "market trend", "availability", "shortage", "current market",
            "supply chain", "material availability",
            # Polish
            "rynek", "dostępność", "oferta", "sprzedaż", "ogłoszenia",
        ],
        "current_info": [
            # English
            "latest", "current", "2024", "2025", "2026", "recent", "now",
            "today", "this year", "new regulation", "updated",
            # Polish
            "aktualny", "aktualne", "obecny", "teraz", "dzisiaj",
            "w tym roku", "najnowsze", "bieżący",
        ],
        "location_specific": [
            # Location queries often need web search
            "w okolicy", "w regionie", "blisko", "niedaleko", "okolice",
            "near", "in the area", "region", "location",
        ],
    }
    ...
    def should_search(
        ...
        location_patterns = [
            ...
            r'\bplot\b', r'\bland\b',  # English: plot, land
        ]
